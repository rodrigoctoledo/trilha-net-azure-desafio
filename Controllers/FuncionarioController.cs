...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        _context.SaveChanges(); // Save changes to the SQL database

        // Creating Log Entry for Azure Table Storage
        var tableClient = GetTableClient();
        var funcionarioLog = new FuncionarioLog(funcionario, TipoAcao.Inclusao, funcionario.Departamento, Guid.NewGuid().ToString());
        UpsertEntity(tableClient, "TableName", funcionarioLog); // Save the log entry to Azure Table Storage
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // TODO: Complete the code with other properties as needed
        ...
        // Save the log entry to Azure Table Storage
        UpsertEntity(tableClient, "TableName", funcionarioLog);
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // Remove the employee from the SQL database
